...
| `display_name` | `text` | no |  |  |  | Optional owner-defined name shown instead of the product name. | `Blue Katla` |
| `description` | `text` | no |  |  |  | Optional Markdown description overriding the product. | `My daily-carry spinner.` |
